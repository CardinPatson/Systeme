 ...
 * 
 * Il est demandé de copier le contenu de l'image magique sans les commentaires et d'en faire une copie
 * Votre code devra parfaitement utilisé la programmation défensive
 * Le format de la commande a tapé devra etre /pnm -f "FORMAT" -i "fichier.format" -o "copie.format"
 * ex : ./pnm -f "PBM" -i "myFile.pbm" -o "yourFIle.pbm"
 *
 * @author: TIAKO NGOUADJE CARDIN PATSON
 * @date: 06/03/2022
 */
